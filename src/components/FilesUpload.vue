...
export default {
  ...
  computed: {
    fileArr: {
      ...
      set(newV) {
        this.$nextTick(() => {
          this.$emit("update:filesList", newV);
        });
      },
    },
  },
  ...
  mounted() {
    let lastUploadFile = [
      {
        uid: "766b7b38d4f039fadc69c2187f18d6f5",
        name: "766b7b38d4f039fadc69c2187f18d6f5.jpeg",
        status: "done",
        url: "https://gtms-sta.guiguoquan.com/dev/attr/2022/06/30/8845c897dd923fdbae14a0625e2a23cc1656559656/1656559663931.jpeg",
      },
      {
        uid: "a00_120200811_lhr",
        name: "a00_120200811_lhr.png",
        status: "done",
        url: "http://tic-gtms.oss-cn-qingdao.aliyuncs.com/dev/attr/2022/07/08/09a5402be73d3ab5a5a61469a4ede1531657274907.png",
      },
    ];
    this.filesList = lastUploadFile;
    this.fileArr = this.filesList;
  },
};
</script>
